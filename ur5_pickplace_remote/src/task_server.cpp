...
#include "ur5_pickplace_msgs/action/ur5_pickplace_task.hpp"
...
namespace ur5_pickplace_remote
{
...
public:
    ...
    : Node("task_server", options)
  {
    ...
    action_server_ = rclcpp_action::create_server<ur5_pickplace_msgs::action::Ur5PickplaceTask>(
...
private:
  rclcpp_action::Server<ur5_pickplace_msgs::action::Ur5PickplaceTask>::SharedPtr action_server_;

  rclcpp_action::GoalResponse goalCallback(
      const rclcpp_action::GoalUUID& uuid,
      std::shared_ptr<const ur5_pickplace_msgs::action::Ur5PickplaceTask::Goal> goal)
  {
  ...
  rclcpp_action::CancelResponse cancelCallback(
      const std::shared_ptr<rclcpp_action::ServerGoalHandle<ur5_pickplace_msgs::action::Ur5PickplaceTask>> goal_handle)
  {
    (void)goal_handle;
  ...
  void execute(const std::shared_ptr<rclcpp_action::ServerGoalHandle<ur5_pickplace_msgs::action::Ur5PickplaceTask>> goal_handle)
  {
    RCLCPP_INFO(get_logger(), "Executing goal");
    auto result = std::make_shared<ur5_pickplace_msgs::action::Ur5PickplaceTask::Result>();
...
RCLCPP_COMPONENTS_REGISTER_NODE(ur5_pickplace_remote::TaskServer)